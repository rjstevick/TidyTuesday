...
games %>% 
   ...
   scale_y_continuous(breaks = c(2500, 5000, 7500, 10000, 12500), labels = scales::label_comma(), limits = c(0,NA)) +
   # change global theme
   theme_ft_rc() +
   # edit theme
