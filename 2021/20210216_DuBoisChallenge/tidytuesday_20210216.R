...
tuesdata %>%
  # make a dataframe of state names and abbreviations, join with data
  ...
  # define fill colors
  scale_fill_manual(values = c("#20211c", "#9a8d7d", "#ccbdaa", "#6f543e", "#2c2449",
                             "#bd354d", "#d5afa6", "#dcac41", "#d2c5b2")) +
  # edit the theme
  theme(text = element_text(family = "Charter"), 
        plot.title = element_text(margin = margin(t=5, b = 80), hjust = 0.5, face = "bold"),
